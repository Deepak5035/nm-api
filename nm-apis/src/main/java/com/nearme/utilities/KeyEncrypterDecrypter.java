...
public class KeyEncrypterDecrypter {
	...
	public KeyEncrypterDecrypter() throws Exception {
	...
	public String KeyDecrypter(String encryptedpassword) {
	...
	public String KeyEncrypte(String emailId, String password) {
